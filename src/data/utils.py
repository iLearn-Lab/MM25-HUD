...
class FrameLoader:
    ...
    def get_video_frames(
        ...
        if self.frames_video != len(frame_idxs):
            ...
            print(f"Sampling {len(frame_idxs)} frames instead")
        ...
        if len(frames) < self.frames_video:
            frames = (frames * self.frames_video)[: self.frames_video]
            # print(f"Dropped {vlen - len(frames)} frames")
