...
'''
@Ziv
WebVidCoVRDataset for target embedding with updated param training model
'''
...
class WebVidCoVRDataModule(LightningDataModule):
    def __init__(
        ...
        **kwargs,  # type: ignore
        ...
        super().__init__()
        print("Init WebVidCoVRDataModule")
...
class WebVidCoVRDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Not Get target embeddings, Instead get the raw transform embedding of target
        target_pth = str(ann["path2"])
        target_vid = self.frame_loader(target_pth)
        ...
        return_dict["ref_description"] = "" 
        return_dict["ref_webvid_caption"] = "" 
        return_dict["tag_description"] = "" 
        return_dict["tag_webvid_caption"] = "" 
